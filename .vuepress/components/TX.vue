...
const colors = [
  ...
  '#D2691E', '#9ACD32', '#20B2AA', '#4682B4', '#5F9EA0', '#C71585', '#F54A45', '#35BD4B',
  '#DF58A5', '#0442D2', '#D99904',
]

// 颜色系列映射
const familyColors: Record<string, string[]> = {
  green: ['#35BD4B','#00a870', '#237804', '#52c41a', '#006633', '#336600', '#092b00', '#5b8c00', '#9ACD32'],
  red: ['#F54A45','#e03c3c', '#a8071a', '#f5222d', '#ff7875', '#c41d7f', '#eb2f96', '#ff9c6e'],
  blue: ['#0442D2','#1456f0', '#1890ff', '#096dd9', '#003a8c', '#1d39c4', '#2f54eb', '#4169e1', '#6495ed', '#1e90ff', '#00bfff', '#87cefa', '#add8e6', '#0000ff', '#0000cd', '#00008b', '#483d8b', '#6a5acd', '#7b68ee'],
  purple: ['#722ed1', '#391085', '#531dab', '#22075e', '#120338', '#5910ad', '#b37feb', '#C71585', '#8B008B', '#9e1068', '#c41d7f'],
  yellow: ['#D99904','#d46b08', '#fa8c16', '#ffc069', '#fa541c', '#d4380d', '#ad2102', '#ff9c6e'],
  orange: ['#fa541c', '#d4380d', '#ad2102', '#ff9c6e', '#ff7875'],
  cyan: ['#13c2c2', '#08979c', '#00474f', '#006d75', '#20B2AA', '#5F9EA0', '#4682B4', '#002329'],
  pink: ['#DF58A5','#eb2f96', '#c41d7f', '#ff7875', '#ff9c6e', '#C71585', '#9e1068'],
